...
# Allgemeine Einstellungen
    ...
    Button1 = Button(fenster, text="Taskleiste Links", **farbe_hg_b, command=lambda: B01(active1))
    Button1.place(x=100, y=120, width=300)
    active1 = Label(fenster, text="O")
    active1.place(x=80, y=120, width=10)

    Button2 = Button(fenster, text="Taskleiste Mitte", **farbe_hg_b, command=lambda: B02(active2))
    Button2.place(x=100, y=160, width=300)
    active2 = Label(fenster, text="O")
    active2.place(x=80, y=160, width=10)

    Button3 = Button(fenster, text="Standard Hintergrund festlegen", **farbe_hg_b, command=lambda: B03(active3))
    Button3.place(x=100, y=200, width=300)
    active3 = Label(fenster, text="O")
    active3.place(x=80, y=200, width=10)

    Button4 = Button(fenster, text="Suchleistenbildchen deaktivieren", **farbe_hg_b, command=lambda: B04(active4))
    Button4.place(x=100, y=240, width=300)
    active4 = Label(fenster, text="O")
    active4.place(x=80, y=240, width=10)

    Button5 = Button(fenster, text="Suchleistenbildchen aktivieren", **farbe_hg_b, command=lambda: B05(active5))
    Button5.place(x=100, y=280, width=300)
    active5 = Label(fenster, text="O")
    active5.place(x=80, y=280, width=10)

    Button6 = Button(fenster, text="Widgets deaktivieren", **farbe_hg_b, command=lambda: B06(active6))
    Button6.place(x=100, y=320, width=300)
    active6 = Label(fenster, text="O")
    active6.place(x=80, y=320, width=10)

    Button7 = Button(fenster, text="Widgets aktivieren", **farbe_hg_b, command=lambda: B07(active7))
    Button7.place(x=100, y=360, width=300)
    active7 = Label(fenster, text="O")
    active7.place(x=80, y=360, width=10)

    Button8 = Button(fenster, text="klassisches Aktionsmenue", **farbe_hg_b, command=lambda: B08(active8))
    Button8.place(x=100, y=400, width=300)
    active8 = Label(fenster, text="O")
    active8.place(x=80, y=400, width=10)

    Button9 = Button(fenster, text="modernes Aktionsmenue", **farbe_hg_b, command=lambda: B09(active9))
